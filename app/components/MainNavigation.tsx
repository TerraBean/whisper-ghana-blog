...
export default function MainNavigation() {
  ...
  useEffect(() => {
    // Only prefetch in production or when not on localhost
    ...
    // If user is admin/editor, prefetch admin-related routes
    if (isAdmin || isEditor) {
      [
        '/admin/manage-users',
        '/admin/edit-post',
  ...
  // Navigation link with prefetch and optimized transition
  const NavLink = ({ href, children, className, mobileStyles, onClick }: { 
    href: string, 
